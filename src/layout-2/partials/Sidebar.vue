        ...
        <div class="surcote">
          <li class="nav-profile">
            <a href="javascript:void(0);" class="nav-link">
              <div
                ...
                <img src="@/assets/images/oms.svg" alt="profile" style="width: 100%; height:100%; margin-top: 3rem; ">
              </div>
            </a>
          </li>
          ...
          <li class="nav-profile">
            <a href="javascript:void(0); nav-link">
              <div
                class="navbar-brand brand-logo text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                <img src="@/assets/images/logo.png" alt="profile" style="width: 100%; height:100%; margin-top: 0rem;">
              </div>
            </a>
          </li>
        </div>
