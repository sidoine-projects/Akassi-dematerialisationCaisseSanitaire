        ...
        <li class="nav-item">
          ...
          <b-collapse accordion="sidebar-accordion" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item">
                <router-link class="nav-link" to="/eph/list">Carte Sanitaire</router-link>
              </li>
              <li class="nav-item">
        ...
        <li class="nav-item">
          <router-link to="/payement/list" style="text-decoration: none;">
            <span class="nav-link" v-b-toggle="'patients'">
              ...
              <i class="menu-arrow"></i>
              <img src="@/assets/images/pay.png" alt="patient" style="width: 1rem; height: 1rem; ">
            </span>
          </router-link>
        </li>
        <li class="nav-item">
          ...
          <b-collapse accordion="sidebar-accordion" id="tresorerie">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <router-link class="nav-link" to="/tresorerie/list-encaissement">Encaissement</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/tresorerie/list-decaissement">Décaissement</router-link>
              </li>
            </ul>
          </b-collapse>
        </li>
