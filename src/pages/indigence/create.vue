  ...
  <section class="container-scroller">
    ...
    <div class="row">
      <div class=" col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Ajouter un pourcentage pour chaque interval d'Age</h4>
            ...
            <form class="forms-sample row">
                ...
                <div class="control-group mt-2 p-2" id="app">
                  <div class="row" v-for="(form, index) in forms" :key="index">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="number" value="" class="form-control" id="agemin" 
                        placeholder="Age Min" v-model="form.agemin">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="exampleInputEmail1">Age Max</label>
                      <input type="number" value="2000" class="form-control" id="text"
                        placeholder="Age Max" v-model="form.agemax">
                    </div>
                    <div class="form-group col-md-4">
              ...
              <div class="mx-auto">
                <button type="submit" class="btn btn-gradient-success mr-2">Ajouter</button>
...
export default {
  ...
  data() {
    return {
      ...
      forms: [    //// crochet simple va faire disparaitre les champs mais avec l'accolade fera apparitre les champs
        {
