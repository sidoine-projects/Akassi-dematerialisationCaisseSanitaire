  ...
  <section class="container-scroller">
    <div class="page-header">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Indigence</li>
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <!-- <h4 class="card-title">Liste des indigences</h4> -->
            <div class="mx-auto mt-2 mb-5">
              <router-link to="/indigence/create">
              ...
              <table id="order-listing" ref="myTable" class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>14</td>
                    <td>3</td>
                    <td>Pourcentage appartenant l'intervalle [05-14]...</td>
