              ...
              <fieldset class="scheduler-border  container-fluid">
                ...
                <div class=" control-group col-md-12  mt-2 " id="app">
                  <div class="row" v-for="(form, index) in forms" :key="index">
                    ...
                    <div v-if="form.acte === 'autre'" class="col-md-12 mb-2 mx-auto">
                      <input type="text" value="" class="form-control" id=""
                        placeholder="Autre" v-model="form.autre">
                ...
                <div class="control-group p-2 col-md-12 ">
                  ...
                  <div class="form-group mx-auto">
                    <label for="exampleFormControlSelec">Mode de Paiement</label>
                    <select class="form-control  mb-3 " id="exampleFormControlSelec" v-model="selectedOption">
...
export default {
  ...
  methods: {
    ...
    addForm() {
      this.forms.push({ acte: 'AL', code: 'FA56718', prix: '1000', quantite: '1', montant: '1000' });
    },
